  ...
  return (
    <div className={styles.home}>
      <Meta
        ...
        description="Portfolio of Dantu Sai Kamal — a Full Stack Engineer working on web & mobile."
      />
      <Intro
        id="intro"
        sectionRef={intro}
      ...
      <ProjectSummary
        ...
        index={3}
        title="ChurnSight: Empowering Telecoms with AI to Predict Customer Loyalty"
        description="Used Machine Learning to anticipate Telecom Churn and Secure Customer Loyalty"
        buttonText="View project"
        buttonLink="/projects/churn"
        model={{
          type: 'laptop',
          alt: 'Annotating a biomedical image in the Slice app',
          textures: [
            {
              srcSet: [dashboardTexture2, dashboardTexture2],
